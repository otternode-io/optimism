...
def main():
    ...
    forge_l1_dump_path = pjoin(contracts_bedrock_dir, 'state-dump-7002.json')
    ...
    paths = Bunch(
      ...
      l1_deployments_path=pjoin(deployment_dir, '88991-deploy.json'),
      ...
      genesis_l2_path=pjoin(devnet_dir, 'genesis.json'),
...
def devnet_l2_allocs(paths):
    ...
    for suffix in ["-delta", ""]:
        input_path = pjoin(paths.contracts_bedrock_dir, f"state-dump-7002{suffix}.json")
...
def devnet_deploy(paths):
    ...
    if os.path.exists(paths.genesis_l2_path):
        ...
        run_command([
            ...
            '--l1-rpc', 'http://119.59.123.103:8545',
